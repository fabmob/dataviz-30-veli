            ...
            <section className="section">
                <div className="container">
                    <div className="content">
                        <h1 className="title">
                            Expérimentation en VELIs
                        </h1>
                        <p>Ce tableau de bord partage des statistiques générales sur les voyages à bord de véhicules légers innovants, mesurées à partir de capteurs embarqués, ainsi que les expériences des testeurs issus de questionnaires.</p>
